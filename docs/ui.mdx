...
<ChangelogDisplay mode="category" category="ui"/>
...
#### Installation:
  ...
  - Readme:<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Quick Readme<br/>
  - Font Options:<br/>
  ...
  - Keybinds:<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> WASD Compatible<br/>
...
- Main File - Clean Vanilla Hud
  - Main Mod:<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Main Files<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Extras<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Clean Shared Interface<br/>
  ...
  - Clean Main Menu Background:<br/>
    ...
    <RadioButtonCheckedIcon fontSize="small" /> None above.<br/>
  - Patches:<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Vanilla UI+ Patch<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> DarnUI Patch<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Alternative Just Hit Indicator<br/>
...
- Main File - Pop-Up Message Icons
  - Pop Up Message Icons!:<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Main Mod<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Extension - Hunger, Dehydration, Sleep and Radiation<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Extension - Reputation<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Extension - Challanges<br/>
...
- Main File - Weapon Hotkey Icons
  - Optionals:<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> ItsMeJesusHChrist Mods Support<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> FO3 Weapons Restoration<br/>
  - Compatibility Patches:<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Just Assorted Mods Compatibility Patch<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Just Weapon Hweel Compatibility Patch<br/>
...
- Main File - Map Marker Icons
  - Main Mod:<br/>
    ...
    <CheckBoxOutlinedIcon fontSize="small" /> Vanilla Plus<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Faction Specific<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Numbered Vaults<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Unique DLC Starter Marks<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Unique Location Icons<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Unique Icons with General Mod Support<br/>
...
- Main File - Colorful Icons Support
  - Interface:<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> ySI - Sorting Icons<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Map Markers<br/>
  - ySI - Categories:<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Weapons<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Apparel<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Aid<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Misc<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Ammo<br/>
  - Colorful Icons - ySI<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Bottlecaps<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Doors<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> UI Prompts<br/>
  - Colorful Icons - Map<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Doors<br/>
  - Optional:<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> ySI - JSON Patcher<br/>
...
- Main File - TTW Goodies
  ...
  - Patch for Weapon Hotkey Icons:<br/>
    <RadioButtonCheckedIcon fontSize="small" /> Install It<br/>
    <RadioButtonUncheckedIcon fontSize="small" /> Don't<br/>
  - Patch for Map Marker Icons:<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Vanilla Plus<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Numbered Vaults<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Unique Location Icons<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Unique DLC Starter Marker<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> None for me, thanks<br/>
...
- Main File - True Colorful Map Marker Icons
  - Icon Variations:<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Colorful Icons<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Colorful Icons with Black Outline<br/>
    <CheckBoxOutlinedIcon fontSize="small" /> Faded Icons<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Faded Icons with Black Outline<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> Black Icons with White Outline<br/>
    <CheckBoxOutlineBlankOutlinedIcon fontSize="small" /> White Icons with Black Outline<br/>
