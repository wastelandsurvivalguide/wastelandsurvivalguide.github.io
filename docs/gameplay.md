...
- Main File - [JAM - Custom INI](https://www.nexusmods.com/newvegas/mods/79005?tab=files&file_id=1000129403&nmm=1)
...
- Optional File - No Big Guns Patch - Optional for those who **DO NOT WANT** the Gun Skill seperated into Guns and Big Guns skills. If skipping this patch and wanting to use the Big Gun Skill, **ENABLE** bEnableBigGunsSkill=1 in the JIP LN NVSE INI.
