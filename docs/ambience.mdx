---
description: Visual, audio, and atmosphere mods to enhance the look and feel of Fallout TTW.
keywords:
  - ambience
  - animations
  - audio
...
- Main File - Iron Sights Aligned
  - Weapon Meshes:<br/>
    <RadioButtonUncheckedIcon fontSize="small" /> Vanilla<br/>
    <RadioButtonCheckedIcon fontSize="small" /> Tale of Two Wastelands<br/>
    <RadioButtonUncheckedIcon fontSize="small" /> Weapon Mesh Improvement Mod<br/>
    <RadioButtonUncheckedIcon fontSize="small" /> Weapon Mesh Improvement and Lovely Forms<br/>
  - Base Animations:<br/>
    <RadioButtonUncheckedIcon fontSize="small" /> Vanilla<br/>
    <RadioButtonCheckedIcon fontSize="small" /> Anniversary Anim Pack<br/>
    <RadioButtonUncheckedIcon fontSize="small" /> FNV Clean Animations<br/>
  - kNVSE Animations:
...
- Main File - [ATMOS - Atmospheric Lighting Tweaks Patch](https://www.nexusmods.com/newvegas/mods/79005?tab=files&file_id=1000180229&nmm=1)
