...
Read the **Mod Installation Instructions** section from the [The Best of Times MO2 section](https://thebestoftimes.moddinglinked.com/mo2.html#installationInstructions).
...
Restart your computer, then install the DirectX Libraries from [here](https://www.microsoft.com/en-us/download/details.aspx?id=8109).

### Why is my game moving too fast?

Verify that NVTF is actually working by using the console command IsDLLLoaded NVTF and limit your FPS according to the [performance guide](https://performance.moddinglinked.com/falloutnv.html).
