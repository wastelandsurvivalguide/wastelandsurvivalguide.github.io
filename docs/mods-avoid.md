...
and other sources which showcase 3D models that are meant for 3D animation. In the majority of cases they are _not_
...
[unnecessary bloat and leftover features from a planned quest](https://imgur.com/a/spSSCZD).
