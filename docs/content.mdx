---
description: New quests, weapons, armor, and other content mods to expand Fallout TTW.
keywords:
  - content
  - weapons
  - locations
...
import ChangelogDisplay from "@site/src/components/CategoryChangelog/index";
...
- Main File - Trooper's Uncut Merge
  ...
  - Patches:
    ...
    - [ ] Mojave Raiders
    - [ ] If it Wasn't For Betsy Remastered
    - [x] Lived-In New Vegas
    - [ ] NV Interiors Re-Remastered
    - [ ] Piber's Unofficial Patches (FNV)
    - [x] Tale Of Two Wastelands
    - [x] The Living Desert
    - [ ] The New Bison Steve Hotel and Lucky Casino
- Optional File - Trooper's Uncut Merge INI File
 
### [Supplemental Restorations and Tweaks](https://www.nexusmods.com/newvegas/mods/99174)

Add-on mod to Trooper's Uncut Merge that restores new content, fixes bugs, and (subjectively) improves features.

#### Installation:

- Main File - Supplemental Restorations And Tweaks TTW
...
### [TLD-MSO LivedInNewVegas 3DNPC Patch](https://www.nexusmods.com/newvegas/mods/99397)

Patch for 3DNPC that fixes npcs spawning in Objects, and overlapping objects/props.

- Main File - TLD LivedInNewVegas 3DNPC Patch
- Main File - MSO 3DNPC Patch
...
- Main File - [DIEO - AWOPFO3 Patch](https://www.nexusmods.com/newvegas/mods/79005?tab=files&file_id=1000180228&nmm=1)
